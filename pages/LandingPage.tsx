...
const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted }) => {
  ...
  return (
    <div className="bg-slate-50 text-slate-800 min-h-screen antialiased font-['Roboto'] flex flex-col">
      <div className="relative isolate overflow-hidden flex-grow">
        ...
        <header className="sticky top-0 z-50 p-4 transition-shadow duration-300 bg-slate-50/80 backdrop-blur-sm">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <nav className="flex items-center gap-4">
                    <Link to="/features" className="hidden sm:inline-block text-sm font-medium text-slate-600 hover:text-indigo-600">Features</Link>
                    <Link to="/dashboard-generator" className="hidden sm:inline-block text-sm font-medium text-slate-600 hover:text-indigo-600">Generator</Link>
                    <button
        ...
        <main className="container mx-auto px-6 pt-24 pb-16 text-center">
          ...
          <p className="mt-6 max-w-3xl mx-auto text-lg text-slate-600">
            Turn Excel into dashboard visuals instantly. The automated dashboard tool that converts CSV to dashboard reports and acts as a powerful BI tool for small business. No coding required.
          </p>
          <div className="mt-10">
            <button
              onClick={handleAction}
        ...
        <section className="container mx-auto px-6 py-24" aria-labelledby="features-title">
            <div className="text-center mb-16">
                <h2 id="features-title" className="text-4xl font-['Montserrat'] font-bold text-slate-900">The Best BI Tool for Small Business</h2>
                <p className="mt-4 text-slate-600 max-w-2xl mx-auto">Everything you need for rapid data analysis and presentation. Spreadsheet to dashboard tool without the complexity.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white p-8 rounded-lg text-center border border-slate-200 shadow-sm">
                    ...
                    <p className="mt-2 text-slate-600">
                        From raw data to beautiful charts in a flash. The automated dashboard tool that generates insights from your Excel or CSV files immediately.
                    </p>
                </div>
                <div className="bg-white p-8 rounded-lg text-center border border-slate-200 shadow-sm">
                    <div className="inline-block p-4 bg-indigo-100 text-indigo-600 rounded-lg mb-4">
                    ...
                    <h3 className="text-xl font-['Montserrat'] font-semibold text-slate-900">No-Code Dashboard Tool</h3>
                    <p className="mt-2 text-slate-600">
                        Don't just view your data, interact with it. Create custom charts, tables, and KPI cards. The perfect Google Sheets dashboard generator for non-technical teams.
                    </p>
                </div>
                <div className="bg-white p-8 rounded-lg text-center border border-slate-200 shadow-sm">
                    <div className="inline-block p-4 bg-indigo-100 text-indigo-600 rounded-lg mb-4">
                    ...
                    <p className="mt-2 text-slate-600">
                        Go beyond the surface. A robust dashboard generator that lets you filter, sort, and perform calculations on the fly. Discover insights you've been missing.
                    </p>
                </div>
            </div>
        </section>
        ...
        <section className="bg-white py-20">
            <div className="container mx-auto px-6 text-center">
                <h2 className="text-4xl font-['Montserrat'] font-bold text-slate-900">Ready to Turn Excel into Dashboards?</h2>
                <p className="mt-4 max-w-2xl mx-auto text-slate-600">
                    Stop wrestling with pivot tables and complex BI tools. Start using the simplest automated dashboard tool today.
                </p>
                <div className="mt-8">
                    <button
                        onClick={handleAction}
